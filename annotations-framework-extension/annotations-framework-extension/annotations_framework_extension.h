...
//! Project version number for annotations_framework_extension.
FOUNDATION_EXPORT double annotations_framework_extensionVersionNumber;

//! Project version string for annotations_framework_extension.
